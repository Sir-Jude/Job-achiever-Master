...
class Adviser_Bot:
    def __init__(self, candidate, recrutier, job, language):
        ...
        self.candidate_hobbies = ", ".join(
            self.candidate.hobbies
        )  # putting all candidate hobbies in a string
        self.candidate_hobbies += "."

        self.candidate_skills = ", ".join(
            self.candidate.skills
        )  # putting all candidate skills in a string
